        ...
        <div class="col-lg-8 col-md-6">
            <div class="product_d_right">
                ...
                <div class="box_quantity mb-20">
                    ...
                    <a href="{{ route('add-to-cart', $product->id) }}" title="THÊM VÀO GIỎ" ><i class="fa fa-shopping-cart"></i> Thêm Vào Giỏ</a>
                </div>
                <div class="product_d_size mb-20">
                    <label for="group_1">Loại bìa</label>
                    <select name="size" id="group_1">
                        <option value="1">Mềm</option>
                        <option value="2">Cứng</option>
                    </select>
                </div>
